...
const MotmManage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 4. Post the plain object to the API
      await API.post(
        "/slider-match/create",
        ...
        <div className="bg-gradient-to-br from-[#041a9659] to-black p-10">
          ...
          >
            ...
            <div>
              ...
              <input
                type="text"
                name="playerName" // <-- 'name' must match schema
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">
                Motm Player Image (URL)
              </label>
              <input
                type="text"
                name="motmImageUrl" // <-- 'name' must match schema
                className="w-full bg-white/20 border border-white/20 rounded px-4 py-2 text-white"
                required
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">
                Motm Player Team Logo (URL)
              </label>
              <input
                type="text"
                name="team1LogoUrl" // <-- 'name' must match schema
                className="w-full bg-white/20 border border-white/20 rounded px-4 py-2 text-white"
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">
                Opponent Player Team Logo (URL)
              </label>
              <input
                type="text"
                name="team2LogoUrl" // <-- 'name' must match schema
                className="w-full bg-white/20 border border-white/20 rounded px-4 py-2 text-white"
              />
            </div>

            {/* MOTM Description -> motmDescription */}
            <div>
              <label className="block text-sm font-semibold mb-2">
                MOTM Description
              </label>
              <input
                type="text"
                name="motmDescription" // <-- 'name' must match schema
                className="w-full bg-white/20 border border-white/20 rounded px-4 py-2 text-white"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                name="opponentPlayerName" // <-- 'name' must match schema
                className="w-full bg-white/20 border border-white/20 rounded px-4 py-2 text-white"
                required
              />
            </div>
            ...
            {/* Motm Player Team Name -> teamName */}
            <div>
              <label className="block text-sm font-semibold mb-2">
                Motm Player Team Name
              </label>
              <input
                type="text"
