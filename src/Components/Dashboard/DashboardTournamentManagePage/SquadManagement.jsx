...
export default function SquadManagement() {
  ...
  const { tournament: currentTournament } = useLocation().state;
  ...
  const team = currentTournament?.teams?.find(
    (team) => team.captain._id === user?._id
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        <div className="xl:col-span-1 order-2 space-y-6">
          <div className="bg-white/5 shadow-allround-yellow p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="w-full bg-border rounded-full h-2">
                <div
                  className="bg-gradient-to-tr from-[#f20604] to-[#fefb04] h-2 w-2 rounded-full transition-all duration-300"
                  style={{
        ...
        <div className="xl:col-span-3">
          <div className="bg-white/5 shadow-allround-green p-6 rounded-lg">
      ...
      {selectedCount > 0 && (
        <div className="shadow-allround-first p-6 rounded-lg">
          <h2 className="text-lg font-semibold text-pink mb-4">
            Selected Squad
          </h2>
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between p-4 rounded-lg ${
                    role === "starPlayer"
                      ? "shadow-allround-star": role === "firstDayPlayer"
                      ? "shadow-allround-first"
                      : "shadow-allround-late"
                  }`}
                >
