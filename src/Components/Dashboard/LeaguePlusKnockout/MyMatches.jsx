...
const MyMatches = ({ tournamentId }) => {
  const { data: { data: { data: matches } = {} } = {}, isLoading } = useQuery({
    queryKey: ["tournamentMatches", tournamentId],
    queryFn: () => {
      return API.get(`/matchHistory/getTournamentMatches/${tournamentId}`, {
        headers: {
  ...
  return (
    <div className="space-y-6 text-white">
      <div className="liquid-glass-card relative overflow-hidden p-4 bg-blue-black sm:p-6 rounded-xl">
